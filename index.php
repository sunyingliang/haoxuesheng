		...
		$(document).ready(function()
					{
						...
						if (/MSIE\s([\d.]+)/.test(navigator.userAgent)) {
							...
							if(version < 9)
							{
								$("#login_area").html("<div style='padding:13px 10px 8px 13px; text-align:left; font-size:11pt !important;'><p>Sorry, you browser is not compatible with our new system.</p><p style='margin:20px 0 10px 0;'>Recommended browsers:</p><p>- Chrome version 35 and above<br />- Internet Explorer 9 and above</p><p  style='margin:20px 0 0 0;'>We are sorry for any inconviences caused.</p></div>");
							}
						}

						//alert($("html").hasClass("ie11")+" "+$.browser.version+" "+parseInt($.browser.version, 10));
