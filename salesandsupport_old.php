...
if(isset($_POST['send']))
{
	...
	if($errorswitch)
	{
		...
		$To = "Charles Tee <charles@acelearn.com>, Peter <support@acelearn.com>";
                            ...
                            <div id="contactform" class="clear products_no_tabs">
                                 ...
                                 <form action="salesandsupport.php" method="post" enctype="multipart/form-data" name="contactform">
                                      <div id="sendernamesection" class="contactusrow">
                                      		<div class="contactfieldlabel">Name<span class="caption_message">*</span></div> <div id="sendername"  class="contactfieldinput"><input class="<?php if(isset($ErrorMessage[1])){echo "border_red contactform_input";}?>" name="nameinput" type="text" maxlength="200" value="<?php echo $nameinput;?>"/><?php if(isset($ErrorMessage[1])) echo "<span>".$ErrorMessage[1]."</span>"?>
                                        	</div>
                                      </div>
                                      <div id="subjectsection" class="contactusrow">
                                        <div class="contactfieldlabel">Email<span class="caption_message">*</span></div>
                                        
                                        <div id="senderemail"  class="contactfieldinput"> <input name="senderemail" type="text" maxlength="250" class="<?php if(isset($ErrorMessage[2]) || isset($ErrorMessage[4])){echo "border_red contactform_input";}?>"  value="<?php echo $senderemail;?>"/><?php if(isset($ErrorMessage[2])){ echo "<span>".$ErrorMessage[2]."</span>";} else if(isset($ErrorMessage[4])){echo "<span>".$ErrorMessage[4]."</span>";} ?> 
                                       </div>
                                       
                                      </div>
                                       <div id="messagesection" class="contactusrow">
                                        <div class="contactfieldlabel">Message<span class="caption_message">*</span></div><div id="message" class="contactfieldinput"><textarea name="messagebody" cols="5" rows="5" class="<?php if(isset($ErrorMessage[3])){echo "border_red contactform_input";}?>"><?php echo $message;?></textarea><?php  if(isset($ErrorMessage[3])) echo "<span>".$ErrorMessage[3]."</span>"?></div>
                                      </div>
                                       <div id="captcha" class="contactusrow">
                                        <div class="contactfieldlabel">&nbsp;</div><div id="captchabox"><?php echo recaptcha_get_html($publickey, $error);?> <?php if(isset($ErrorMessage[5])) echo "<span class='captcha_error'>".$ErrorMessage[5]."</span>"?></div>
                                      </div>
                                      
                                      <div id="messagesection" class="contactusrow">
                                        <div class="contactfieldlabel">&nbsp;</div><div id="sendmessage" class="contactfieldinput"> <input name="send" type="submit" value="Send" id="send"/></div>
                                      </div>
