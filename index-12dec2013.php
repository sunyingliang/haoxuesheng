<?php
	if($_SERVER['QUERY_STRING']=="")
	{
		...
		{
			header ("Location:  http://" . $_SERVER['HTTP_HOST'] . "/w/index.php?sd=".$_SESSION['createdSessionID']);
			exit();
...
<script>
	...
	{
		/*window.location = "http://www.ace-learning.com/index.php";*/
	}
	/**
		<!--frame breaker. this page should not be inside a frame.-->
	*/
...
<li style="padding-left:20px">and change your username/password immediately.</li>
        ...
        <div id="content_left" class="theme-default">
               <div id="rotating_img" class="nivoSlider">
					  <a href="overview.php"><img src="images/website/Web_scene_01.jpg" alt="Image 2"/></a>
					  <a href="products.php"><img src="images/website/Web_scene_02.jpg" alt="Image 3"/></a>
					  <a href="eschool.php"><img src="images/website/Web_scene_03.jpg" alt="Image 4"/></a>
					  <a href="mobileapps.php"><img src="images/website/Web_scene_04.jpg" alt="Image 1"/></a>
                </div>
                <div id="price_area" class="clear" style="margin-top:13px;">
                	<ul class="ul-h12">
                    	<li class="dl12 ui-corner-all" dest="products">
                        	<table width="100%" cellspacing="0" cellpadding="0" border="0">
                            	<tr>
                                	<td class="td1">Grade 7 - 12<br />Mathematics</td>
                                </tr>
                                <tr>
                                	<td class="td2"><img src="img/web/aboutus_overview.png" width="56" height="56" /></td>
                                </tr>
                                <tr>
                                	<td class="td3">$9.99/month</td>
                                </tr>
                            </table>
                        </li>
                        <li class="dl12 ui-corner-all" dest="ea">
                        	<table width="100%" cellspacing="0" cellpadding="0" border="0">
                            	<tr>
                                	<td class="td1">Exploratory<br />Activities</td>
                                </tr>
                                <tr>
                        ...
                        <li class="dl12 ui-corner-all" style="width:136px;" dest="pmp">
                        	<table width="100%" cellspacing="0" cellpadding="0" border="0">
                            	<tr>
                                	<td class="td1">Progressive Mastery Programme</td>
                                </tr>
                                <tr>
                        ...
                        <li class="dl12 ui-corner-all" dest="itools">
                        	<table width="100%" cellspacing="0" cellpadding="0" border="0">
                            	<tr>
                                	<td class="td1">Interactive<br />Tools</td>
                                </tr>
                                <tr>
                        ...
                        <li style="margin-right:0px;" class="dl12 ui-corner-all" dest="merk">
                        	<table width="100%" cellspacing="0" cellpadding="0" border="0">
                            	<tr>
                                	<td class="td1">Math Exam Revision Kit</td>
                                </tr>
                                <tr>
        ...
        <div id="content_right">
            	...
            	<div id="login_area" class="clear ui-corner-all box box-background">
               		<form name="login_form" id="login_form" action="http://www.ace-learning.com/w/index_login.php" method="POST">
                      ...
                      <span class="forgotpass"><a href="forgotpassword.php" >Forgot password?</a>
                ...
                <div id="socials" class="ui-corner-all widget_header_social <?php echo $boxspacing; ?>">
                    ...
                    <ul class="widget_icons">
                        ...
                        <!--<li>
						<a href="#">
							<img src="images/layout_assets/googleplus_logo.png" alt="android" />
                            	<p>Google+</p>
                        </a>
                        </li>-->
                    </ul>
