	...
	<div class="wrapper">
         ...
         <div id="products_content" class="box remove_bg">
         	 <div class="title_page"> 
                    ...
                    <br />
                    <span class="consultant_name">
                        Effective Date: December 01, 2012
                    </span>
            </div>
            <div id="product_tabs" class="clear products_no_tabs">
            	 <div id="overview" class="contents_area">
                 	<p>
                        Ace-Learning.com, <strong>(referred to as "us" or "we" or "Ace-Learning.com" or &quot;Ace-Learning Systems Pte. Ltd.&quot;)</strong>, is committed to protecting and respecting your privacy.  This Privacy Policy describes the types of information we may collect from you or that you may provide when you visit the Ace-Learning.com website located at <a href="http://www.ace-learning.com" target="_new">www.ace-learning.com</a> <strong>("Website")</strong>, and our practices for collecting, using, maintaining, protecting and disclosing such information.  This Privacy Policy is part of the Ace-Learning.com Website <em>Terms of Use</em> <strong>(collectively, the "Website Policies")</strong>, and you accept that by accessing or using the Website, you agree to be bound by all the terms of the Website Policies.  This Privacy Policy applies to information we collect: (i) on this Website, (ii) in text and electronic messages between you and this Website, and (iii) via mobile applications you download from this Website, which provide dedicated non-browser-based interactions between you and this Website.  This Privacy Policy does not apply to any information collected by us offline or via third-party sites that may be accessed through hyperlinks on this Website.
                    </p>
                    <br />
    				<p>
...
The data that we collect from you may be transferred to, and stored at, a destination in Singapore.  It may also be processed by staff operating outside Singapore who works for us or for one of our service providers.  Such staff maybe engaged in, among other things, the fulfillment of your order, the processing of your payment details and the provision of support services.  By submitting your personal data, you agree to this transfer, storing or processing.  Ace-Learning.com will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy.
 ...
 <p class="consultant_name">3.   HOW WE USE YOUR INFORMATION</p><br />
<p>
We use information held about you in the following ways:
    ...
    <li>If you pay for a service using a credit card, we will transmit your credit card data to the appropriate credit card company and/or credit card payment processing company</li>
    <li>To allow you to participate in interactive features of our service, when you choose to do so</li>
    <li>To notify you about changes to our service</li>
    <li>In any other way we may describe when you provide the information</li>
        </ul><br />
<p>If you are an existing customer, we will only contact you by electronic means (e-mail or SMS) with information about goods and services similar to those, which were the subject of a previous sale to you.</p><br />

<p>If you are a new customer, and where we permit selected third parties to use your data, we (or they) will contact you by electronic means only if you have consented to this.</p><br />

<p>If you use the Contact Us form on our site, we will respond to your inquiry and delete the information provided after your request has been fulfilled.</p>
<br />
 <p class="consultant_name">4.   DISCLOSURE OF YOUR INFORMATION</p><br />
<p>
...
<li>To a 3rd party with your prior consent to do so; or </li>
<li>If we are under a duty to disclose or share your personal data in order to enforce or apply our Website Policies, or any contracts or agreement that may exist between you and Ace-Learning.com. This includes exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction.</li>
       </ul><br />

<p>(c) In the event that Ace-Learning.com decides to sell all or part of its stock or assets or enter into a merger, we reserve the right to include Personally Identifiable Information and Non-Personally Identifiable Information among the assets transferred to the acquiring or surviving company.</p><br />

  <p> (d) We may provide Non-Personally Identifiable Information about our customers' sales, traffic patterns, and related Website information to third party advertisers, but these statistics do not include any Personally Identifiable Information.</p><br />

<p>   (e) Parent's are able to consent to the use of their child's Personal Information without having to consent to the Website's disclosure of the child's Personal Information to third parties, as we do not share personal information of children under the age of 13 with any third parties (other than those service partners who help us provide the Ace-Learning.com service to you).</p><br />

 <p class="consultant_name">5.   UPDATING OR CORRECTING YOUR PERSONALLY IDENTIFYING INFORMATION</p><br />

<p>You may change any of yours or your child's Personally Identifiable Information online by logging into "Ace-Learning Account" in accordance with instructions posted elsewhere on this Website.</p><br />
<p>
...
<p>
10 UBI Crescent<br/>
#06-95 UBI Techpark<br />
Singapore 408564
</p><br />
<p>Please include yours or your child's name, address, and e-mail address when you contact us.  We encourage you to promptly update yours or your child's Personally Identifiable Information if it changes.  You may ask to have the information on yours or your child's account deleted or removed and request that we no longer have contact with your child; however, because we keep track of past transactions, you cannot delete information associated with past transactions on this Website.  In addition, it may be impossible to completely delete your information without some residual information because of backups.</p><br />

<p class="consultant_name">6.   CANCELLING YOUR ACCOUNT OR DELETING PERSONALLY IDENTIFIABLE INFORMATION</p><br />

<p>
If you are Ace-Learning.com subscriber and would like to cancel your membership, please contact your sales representatives or contact support@acelearn.com.  To have any personally identifiable information deleted, please contact: support@acelearn.com.
...
<p class="consultant_name">7.   CHOICES REGARDING YOUR CONTROL OF YOUR PERSONALLY IDENTIFIABLE INFORMATION</p><br />
<p>
...
<p class="consultant_name">8.   INFORMATION RELATED TO DATA COLLECTED THROUGH THE<br />ACE-LEARNING.COM PLATFORM SERVICE</p>
<br />
<p>
...
<p class="consultant_name">9.   DATA SECURITY</p>
<br />
<p>
...
<p>
In the unlikely event that we believe that the security of your Personally Identifiable Information in our control may have been compromised, we will notify you as promptly as possible under the circumstances.  To the extent we have your e-mail address, we may notify you by e-mail and <span style="text-decoration:underline">you consent to our use of e-mail as a means of such notification</span>.  If you prefer for us to use another method to notify you in this situation, please e-mail us at support@acelearn.com with the alternative contact information you wish to be used.
</p><br />
<p class="consultant_name">10.   COOKIES</p><br />
<p>When you use our Website we will store cookies on your computer in order to facilitate and customize your use of our Website.</p><br />
<p>
<strong<em>>What is a cookie?</em></strong>  A cookie is a small data text file, which a website stores on your computer's hard drive (if your Web browser permits) that can later be retrieved to identify you to us.</p><br />
<p>
Our cookies store randomly assigned user identification numbers, the country where you are located, and your first name to welcome you back to our Website.  The cookies make your use of the Website easier, make the Website run more smoothly, and save your logged-in state so that you do not have to log in each time that you visit the Website.  You are always free to decline our cookies if your browser permits, but if you do so, our Website will not recognize your computer and you may not have access to all portions of the Website.</p><br />
<p>
The use of cookies by our partners, affiliates, tracking utility company, service providers, is not covered by our Privacy Policy.  We do not have access or control over these cookies.  Our partners, affiliates, tracking utility company, and service providers, use session ID cookies to make it easier for you to navigate our site, in order for you to use the shopping cart, etc.</p><br />
<p>
...
<p>
Your continued use of the Website after such modifications will constitute your: (a) acknowledgment of the modified Privacy Policy; and (b) agreement to abide and be bound by the modified Privacy Policy.</p><br />
<p>
...
<p class="consultant_name">15.   COMMUNITIES, FORUMS, CHAT ROOMS, AND MESSAGE BOARDS</p><br />
<p>
...
<p class="consultant_name">16.   SOCIAL MEDIA FEATURES</p><br />
<p>
...
<p class="consultant_name">17.   HOW DO YOU CONTACT US WITH QUESTIONS?</p><br />
<p>
...
10 Ubi Crescent<br />
#06-95 Ubi Techpark<br />
Singapore 408564<br /><br />

<span style="display:inline-block; width:40px">Tel:</span>(65) 6848 9320<br />
<span style="display:inline-block; width:40px">Fax:</span>(65) 6848 9321<br />
<span style="display:inline-block; width:40px">Email:</span>support@acelearn.com
</p><br />
<p>
